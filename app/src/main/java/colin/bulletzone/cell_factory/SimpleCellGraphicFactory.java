package colin.bulletzone.cell_factory;

import colin.bulletzone.cell.cell_data.AbstractCellData;
import colin.bulletzone.cell.cell_graphic.AbstractCellGraphic;
import colin.bulletzone.cell.cell_graphic.BulletCellGraphic;
import colin.bulletzone.cell.cell_graphic.GrassCellGraphic;
import colin.bulletzone.cell.cell_graphic.TankCellGraphic;
import colin.bulletzone.cell.cell_graphic.WallCellGraphic;
...
public class SimpleCellGraphicFactory {
    ...
    public static AbstractCellGraphic makeGraphic(int rawData) {
        ...
        { // indestructible wall entity
            cell = new WallCellGraphic(false);
        }
        else if(rawData > 1000 && rawData <= 2000)
        { // destructible wall entity
            cell = new WallCellGraphic(true);
        }
        else if(rawData >= 2000000 && rawData <= 3000000)
        { // bullet entity
            cell = new BulletCellGraphic();
        }
        else if(rawData >= 10000000 && rawData <= 20000000)
        { // tank entity
            /**
            ...
            if(tid == GameActivity.tankId)
            { // client's tank entity
