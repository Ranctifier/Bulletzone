...
import colin.bulletzone.cell.cell_data.BulletCellData;
import colin.bulletzone.cell.cell_data.GrassCellData;
import colin.bulletzone.cell.cell_data.TankCellData;
import colin.bulletzone.cell.cell_data.WallCellData;
...
public class SimpleCellDataFactory {
    ...
    /**
     * Creates and returns an AbstractCellData object given some rawData in
     * the form of an integer. It is assumed that the class using this
     * factory knows the row and column the AbstractCellData is for.
     * @param rawData
     * @return
     */
