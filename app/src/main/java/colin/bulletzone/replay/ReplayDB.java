...
import colin.bulletzone.memento.MementoTriple;
...
public class ReplayDB extends SQLiteOpenHelper {
     ...
     * generated that will insert strings that are equivalent to the data
     * from sessionData into the ReplayDB. After the current iteration's
     * string is generated, it is used in a raw query to place it into
     * ReplayDB's SESSION_DATA table.
     *
     * @param sessionData
     */
    @Background
    ...
    /**
     * Generates and runs a SQL query that deletes the rows in the
     * SESSIONS_DATA table.
     */
    @Background
...
//        replayDB.rawQuery(deleteRaw, null);
    ...
    /**
     * Returns a cursor containing the data from the SESSION_DATA table.
     * Sets the hasData variable as a result;
     * @return
     */
