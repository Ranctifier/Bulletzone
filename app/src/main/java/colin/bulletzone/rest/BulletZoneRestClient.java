...
import colin.bulletzone.wrapper.BooleanWrapper;
import colin.bulletzone.wrapper.GridWrapper;
import colin.bulletzone.wrapper.LongWrapper;
...
public interface BulletZoneRestClient extends RestClientErrorHandling {
    ...
    /**
     * The grid command for a Rest interface, client uses this to obtain
     * the joined game's state, a grid of data.
     * @return
     */
    @Get("")
    GridWrapper grid();
    ...
    /**
     * The fire command for a Rest interface, client uses this to fire a
     * bullet. The bullet will move forward based on the directional
     * orientation of the tank when it was fired.
     * @param tankId
     * @return
     */
    @Put("/{tankId}/fire")
