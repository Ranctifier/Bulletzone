package colin.bulletzone.update;
...
public class Poller {
     ...
     * bulletzone game every 100 milliseconds. Run in a background thread
     * to avoid slowing the UI thread and other bottlenecks.
     */
    ...
    /**
     * Uses the BusProvider class to post a message to any classes subscribed
     * to the BusProvider. The message in this case has the contents of a
