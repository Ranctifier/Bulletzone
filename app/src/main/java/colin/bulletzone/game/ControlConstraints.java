...
public class ControlConstraints {
    ...
    /**
     * Constructor to initialize the variables used to implement constraints
     * for the BulletZone game activity.
     */
     ...
     * this constrains whether or not the client's tank may turn 90 degrees
     * left or right from its current facing.
