...
import colin.bulletzone.dispatcher.Dispatcher;
import colin.bulletzone.memento.SessionCaretaker;
import colin.bulletzone.replay.ReplayDB;
import colin.bulletzone.rest.BulletZoneRestClient;
import colin.bulletzone.update.BusProvider;
import colin.bulletzone.update.Poller;
...
public class GameActivity extends Activity {
    ...
    /**
     * Sets the text of the tank id textview, which should be the client's
     * tank id. Used in the UI thread to update the UI directly.
     */
    @UiThread
    void updateTankId(){
    ...
    /**
     * Attempts to join a bulletzone server, update the client's tank id,
     * sets the dispatcher's context, initializes the session caretaker, starts
     * the poller, and starts the dispatcher. Used in a background thread.
     */
    @Background
    void join(){
        try{
    ...
    /**
     * Method that runs when Activity is resumed. Also registers
     * the dispatcher's eventHandler to the BusProvider.
     */
    @Override
    ...
    /**
     * Method that runs when Activity is paused. Also unregisters
     * the dispatcher's eventHandler from the BusProvider.
     */
    @Override
    ...
    /**
     * Sets the grid to visible, called when game begins or from a previous
     * game over.
     */
    @UiThread
    ...
    /**
     * Method that sets the grid to invisible.
