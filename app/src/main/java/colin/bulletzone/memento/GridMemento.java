package colin.bulletzone.memento;
...
public class GridMemento {
     ...
     * the cell data array, converts its contents into a string, and then
     * sets the gridState to that string.
     *
     * The order of elements in the encoded string for a cell are:
     * type, direction, row, column
     *
     * The type and direction elements are plain integers and unchanged from
     * the specification. The row and column elements are plain integers
     * converted into their hexadecimal equivalent.
     *
     * Since there are 16 rows and elements in a default grid, an encoded
     * string for a cell is 4 characters long. An encoded string for an entire
     * default grid is 1024 characters long.
     *
     * @param gridData
     */
    ...
    public void setGridState(AbstractCellData[][] gridData) {
        ...
        { // create stringbuilder using cell data
