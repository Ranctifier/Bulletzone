...
//    private static Hashtable<String, HashSet<Pair<Integer, Integer>>> sessionSlices;
    ...
    /**
     * Constructor to initialize updateCount and calls createStorage.
     * In order to create a new storage object, there must be no currently
     * active session. By default a session is inactive until startSession
     * is called.
     */
...
//    }
     ...
     * If an active session exists, this method does the following:
     * Places the passed 2D array of grid data into a memento.
     * After the data is converted to a GridMemento, processMemento is called
     * which stores the GridMemento for later use.
     *
