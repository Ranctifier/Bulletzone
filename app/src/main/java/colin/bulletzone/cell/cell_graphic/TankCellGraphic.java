    ...
    public TankCellGraphic(boolean isUser, int life, int direction) {
        ...
        else
        {
            if(life == 3){
                type = 6;
                switch (direction){
                    case 0: resId = R.drawable.other_tank0;
                        break;
                    case 2: resId = R.drawable.other_tank1;
                        break;
                    case 4: resId = R.drawable.other_tank2;
                        break;
                    case 6: resId = R.drawable.other_tank3;
                        break;
                }
            }
            else{
                type = 7;
                switch (direction){
                    case 0: resId = R.drawable.other_tank_damaged0;
                        break;
                    case 2: resId = R.drawable.other_tank_damaged1;
                        break;
                    case 4: resId = R.drawable.other_tank_damaged2;
                        break;
                    case 6: resId = R.drawable.other_tank_damaged3;
                }
            }
        }
